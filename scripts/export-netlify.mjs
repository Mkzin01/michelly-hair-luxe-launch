...
async function prerenderRoutes() {
  const proc = spawn("bunx", ["wrangler", "dev", "--config", "dist/server/wrangler.json", "--local", "--port", String(PORT), "--compatibility-date", "2026-07-28", "--compatibility-flag", "nodejs_compat"], {
    cwd: ROOT,
